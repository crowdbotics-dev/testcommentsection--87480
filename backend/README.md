...
## Project Structure
    ...
    ├── testcommentsection__87480  # Django project configurations
...
1. Clone this repo and `cd testcommentsection__87480`
...
2. Clone this repo and `cd testcommentsection__87480`
